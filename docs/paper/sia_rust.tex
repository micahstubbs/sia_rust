...
\author{%
  Micah Stubbs\thanks{Status: iterative working draft (preprint-style). This is a
...
\end{lstlisting}
\caption{The \texttt{sia\_rust} architecture: native Rust meta/feedback runners with
a Python bridge only for target execution.}
\label{fig:arch}
\end{figure}
