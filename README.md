...
- [EVALUATION_GUIDE.md](EVALUATION_GUIDE.md) — tasks, MLE-Bench, the `evaluate.py` contract, and preparing MLE-Bench competition datasets (`sia/prepare_mlebench_dataset.py`).
